...
/**
 * This object is designed to provide a simple interface for accessing SharedPreferences.
 * It is particularly useful when working with ViewModels or other components where you need to manage different types
 * of data.
 *
 * @see [https://gist.github.com/JCarlosR/7f457aeebd9c3670933221e97116c4c6]
 */
object PrefsUtils {
